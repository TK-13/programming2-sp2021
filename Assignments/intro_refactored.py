...
def validated_input(message, options_list, response="", options_message="Valid Options: ", print_options=True):
    if print_options:
...
def main():
    ...
    introvert_extrovert_letter = validated_input("Please enter the corresponding letter: ", ['a', 'b', 'c'],
                                                 response="That is not a valid input.",
                                                 options_message="", print_options=False)
